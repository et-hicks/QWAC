...
# ACDS 19.1 670 win32 2020.05.12.07:47:25
# ----------------------------------------
...
# ----------------------------------------
# If fpga_built_in_clk is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fpga_built_in_clk"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpga_built_in_clk.vo"
}
